...
public class CalendarEx9 {
	public static void main(String [] args) {
		...
		System.out.println("735778 : " + convertDayToDate2(735778));
	...
	public static String convertDayToDate2(int day) {
		int year=1;
		int month=0;
		//연도 계산
		int [] years = {400, 100, 4, 1};
		int [] days = {(365*400 + 100 - 3 ), 365*100 + 25 - 1, 365*4 + 1, 365 };// 400년 단위, 100년 단위, 4년 단위, 1년 단위
...
//		}
		int operand;
		for(int off=0; off<years.length; ++off) {
			operand = day / days[off];
			year += years[off]*operand;
			day -= days[off]*operand;			
		}
	...
	public static int convertDateToDay(int year, int month, int day) {
		...
		for(int i=0; i<month-1; i++) thisYearDaySum+=endOfMonth[i];
